...
public class ReceiveChemical extends AppCompatActivity {
    String ID;
    String Role;
    String Parent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlName.append(":8080/ReceiveList.php");
        url = urlName.toString();
        ////Log.d("TAG", url);
        setContentView(R.layout.activity_receive_chemical);
    ...
    private void getChemical (String ChemID, final int position) {
        ...
        class GetChemJSON extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                //myJSONC = result;
                ////Log.d("TAG", myJSON);
                Intent intentDetails = new Intent(ReceiveChemical.this, LogDetails.class);
    ...
    protected void showList() {
        ...
        try {
            ...
            //Log.d("TAG", "showList myJSON: " + myJSON);
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ReceiveChemical.this, LogList, R.layout.log_list_element,
