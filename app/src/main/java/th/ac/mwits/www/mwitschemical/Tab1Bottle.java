...
public class Tab1Bottle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab1_bottle);
    ...
    private void getData() {
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... args) {
                ...
                URL url = null;
                try {
                    url = new URL("http://" + getString(R.string.serverAddress) + ":8080/1Bottle.php");
    ...
    protected void showList(){
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Tab1Bottle.this, ChemList, R.layout.chemical_list_element,
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> list, View view, int position, long id) {
                    Intent intentDetails = new Intent(Tab1Bottle.this, ChemicalDetails.class);
