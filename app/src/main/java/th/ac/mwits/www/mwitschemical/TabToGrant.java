...
public class TabToGrant extends AppCompatActivity {
    String ID;
    String Role;
    String Parent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlName.append(":8080/ToGrant.php");
        url = urlName.toString();
        ////Log.d("TAG", url);
        setContentView(R.layout.activity_tab_to_grant);
    ...
    private void getChemical (String ChemID, final int position) {
        ...
        class GetChemJSON extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                //myJSONC = result;
                ////Log.d("TAG", myJSON);
                Intent intentDetails = new Intent(TabToGrant.this, LogDetails.class);
    ...
    protected void showList(){
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    TabToGrant.this, LogList, R.layout.log_list_element,
