...
public class GrantPermission extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlName.append(":8080/GrantList.php");
    ...
    private void getChemical (String ChemID, final int position) {
        ...
        class GetChemJSON extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                //myJSONC = result;
                //Log.d("TAG", myJSON);
                Intent intentDetails = new Intent(GrantPermission.this, LogDetails.class);
    ...
    protected void showList(){
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    GrantPermission.this, LogList, R.layout.log_list_element,
