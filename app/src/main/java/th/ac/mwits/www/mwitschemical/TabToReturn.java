...
public class TabToReturn extends AppCompatActivity {
    String ID;
    String Role;
    String Parent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlName.append(":8080/ToReturn.php");
        url = urlName.toString();
        ////Log.d("TAG", url);
        setContentView(R.layout.activity_tab_to_return);
    ...
    private void getChemical (String ChemID, final int position) {
        ...
        class GetChemJSON extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                //myJSONC = result;
                ////Log.d("TAG", myJSON);
                Intent intentDetails = new Intent(TabToReturn.this, LogDetails.class);
    ...
    protected void showList(){
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    TabToReturn.this, LogList, R.layout.log_list_element,
